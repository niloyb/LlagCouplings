...
```
In this tutorial we reproduce a stylized example from the paper [Estimating Convergence of Markov chains with L-Lag Couplings](https://arxiv.org/abs/1905.09971) by Niloy Biswas, Pierre E. Jacob and  Paul Vanetti. Individual scripts 
